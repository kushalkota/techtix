  ...
  return (
    <div id="services">
      <div className="service-intro">
        <h1>Mobile Repair</h1>
        <p>
          TECHTIX is a professional mobile service center in bangalore, with
          customer Satisfactory Solutions. We have 5 years of expertise in
          servicing various kinds of mobile phones. We have a professionally
          expertise and qualified technicians with highly equipped
          infrastructure in the repair field for various brands of mobile
          phones. We are Specialized in
        </p>
      </div>
